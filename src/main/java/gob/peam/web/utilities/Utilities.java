...
public class Utilities {
    ...
    public static Conf_Web getConf_Web(String path, String nameFile) {
        ...
        try (InputStream inputstream = new FileInputStream(path + nameFile)) {
            ...
            conf.setDirector_infraestructura(prop.getProperty("director_infraestructura"));
            conf.setNombre_foto_director_infraestructura(prop.getProperty("nombre_foto_director_infraestructura"));
            conf.setDirector_manejo_ambiental(prop.getProperty("director_manejo_ambiental"));
            conf.setNombre_foto_director_manejo_ambiental(prop.getProperty("nombre_foto_director_manejo_ambiental"));
            conf.setDirector_desarrollo_agropecuario(prop.getProperty("director_desarrollo_agropecuario"));
            conf.setNombre_foto_director_desarrollo_agropecuario(prop.getProperty("nombre_foto_director_desarrollo_agropecuario"));
            conf.setDirector_area_estudios(prop.getProperty("director_area_estudios"));
            conf.setNombre_foto_director_area_estudios(prop.getProperty("nombre_foto_director_area_estudios"));
    ...
    public static String setConf_Web(Conf_Web conf, String path, String nameFile) {
        ...
        try {
            ...
            try (InputStream inputstream = new FileInputStream(path + "/" + nameFile)) {
                ...
                prop.setProperty("director_infraestructura", conf.getDirector_infraestructura());
                prop.setProperty("nombre_foto_director_infraestructura", conf.getNombre_foto_director_infraestructura());
                prop.setProperty("director_manejo_ambiental", conf.getDirector_manejo_ambiental());
                prop.setProperty("nombre_foto_director_manejo_ambiental", conf.getNombre_foto_director_manejo_ambiental());
                prop.setProperty("director_desarrollo_agropecuario", conf.getDirector_desarrollo_agropecuario());
                prop.setProperty("nombre_foto_director_desarrollo_agropecuario", conf.getNombre_foto_director_desarrollo_agropecuario());
                prop.setProperty("director_area_estudios", conf.getDirector_area_estudios());
                prop.setProperty("nombre_foto_director_area_estudios", conf.getNombre_foto_director_area_estudios());
