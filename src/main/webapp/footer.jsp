<footer class="footer footer-four">
    <div class="primary-footer light-green text-center">
        <div class="container">
            <a href="#top" class="page-scroll btn-floating btn-large back-top waves-effect waves-light" style="background-color:  #8b8c8d" data-section="#top">
            ...
            <ul class="social-link tt-animate ltr mt-20">
                <%
                    for (int i = 0; i < valoresRedesSociales.length; i++) {
                        ...
                        out.print("<li><a href='" + valorItem[1] + "' " + target + "><i class='" + valorItem[2] + "'></i></a></li>");
                    }
                %>
           </ul>
            <hr class="mt-15">
