		...
		<div class="rev_slider materialize-slider">
			<ul>
				<li data-transition="fade" data-slotamount="default"
					...
					src="assets/img/banner/banner-1.jpg" alt=""
					...
					<div
						...
						data-lineheight="['60','60','60','50']" data-width="none"
						...
						style="z-index: 5; white-space: nowrap;">Título de noticia
						#1</div> <!-- LAYER NR. 2 -->
					<div
						...
						Materialize is an interactive agency. Which develops websites <br>
						and premium mobile applications.
					</div> <!-- LAYER NR. 3 -->
					<div class="tp-caption tp-resizeme rev-btn"
						...
						<a href="#" class="btn btn-lg  waves-effect waves-light">Leer
							más</a>
					</div></li>
				<!-- slide 1 end -->
				<!-- slide 2 start -->
				<li data-transition="fade" data-slotamount="default"
					...
					<div
						...
						data-start="800" data-splitin="none" data-splitout="none"
						data-responsive_offset="on"
						style="z-index: 5; white-space: nowrap;">Título de la
						segunda noticia</div> <!-- LAYER NR. 2 -->
					<div
						class="tp-caption tp-resizeme rev-subheading dark-text text-center"
						data-x="center" data-y="center" data-voffset="30"
						data-whitespace="nowrap" data-transform_idle="o:1;"
			...
			<div class="row">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item next left">
								<img class="img-responsive"
									src="assets/img/portfolio/single-project-1.jpg" alt="">
							</div>
							<div class="item">
								<img class="img-responsive"
									src="assets/img/portfolio/single-project-2.jpg" alt="">
							</div>
							<div class="item active left">
								<img class="img-responsive"
									src="assets/img/portfolio/single-project-3.jpg" alt="">
							</div>
						</div>

						<!-- Controls -->
						<a class="left carousel-control" href="#project-slider"
							role="button" data-slide="prev"> <span
							class="fa fa-angle-left" aria-hidden="true"></span> <span
							class="sr-only">Previous</span>
						</a> <a class="right carousel-control" href="#project-slider"
				...
				<div class="col-md-3 col-xs-12">
					<div class="team-wrapper text-center">
						<div class="team-img">
							<a href="#"><img src="assets/img/team/team-1.jpg"
						...
						<div class="team-title">
							<h3>
								<a href="#"><font style="vertical-align: inherit;"><font
										style="vertical-align: inherit;">John Smith</font></font></a>
							</h3>
							<span class="mb-10"><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">Gerenta General</font></font></span>
							<h5>
								<i class="fa fa-phone"></i> 949836533
							</h5>
							<h5 class="mb-30">
								<i class="fa fa-envelope-o"></i> jamescc821@gmail.com
							</h5>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="gallery-thumb">
						<ul class="slides">
							<li data-thumb="assets/img/gallery/author-1.jpg"><img
								src="assets/img/gallery/author-1.jpg" alt="image"></li>
							<li data-thumb="assets/img/gallery/author-2.jpg"><img
								src="assets/img/gallery/author-2.jpg" alt="image"></li>
							<li data-thumb="assets/img/gallery/author-3.jpg"><img
								src="assets/img/gallery/author-3.jpg" alt="image"></li>
							<li data-thumb="assets/img/gallery/author-4.jpg"><img
								src="assets/img/gallery/author-4.jpg" alt="image"></li>
						</ul>
					</div>
					<!-- /.gallery-thumb -->
				</div>
