/*
 ...
 Autor: David Mares | Modificado Por: James Carrillo
...
(function (window, document) {
    ...
    var addNode = function (parent, data) {
        ...
        if (data != undefined) {
            ...
            item.setAttribute('iditem-caja', data.id);
            nodo.appendChild(item);
...
//            nodo.appendChild(item);
            ...
            if (childs != 0) {
                ...
                for (var i = 0; i < childs; i++) {
                    ...
                    tds.className = 'line-org ';
                    tds.innerHTML = '&nbsp;';
                    if (childs == 2) {
                        if (i % 2 == 0)
                            tds.className += 'right-org';
                        else
                            tds.className += 'left-org';
                    }
                    if (i != 0 && i != childs - 1) {
                        if (i % 2 == 0)
                            tds.className += 'right-org up';
                        else
                            tds.className += 'left-org up';
                    }
                    trs.appendChild(tds);
                }
...
//            btn.className = 'btn btn-sm-org btn-primary btn-block btn-add';
//
