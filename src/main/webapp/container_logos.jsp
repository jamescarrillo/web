<div class="container">
    ...
    <div class="row" id="row_logos_md">
        ...
        <div class="col-md-6" style="padding-top: 25px">
            <a href="<%out.print(getServletContext().getContextPath());%>/index">
                <img class="img-responsive" src="<%out.print(getServletContext().getContextPath());%>/peam_resources/logos_principales/logo_peam_combinado_large.png" alt="" style="height: 40px"/>
            </a>
        </div>
