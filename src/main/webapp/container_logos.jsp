<div class="container">
    ...
    <div class="row" id="row_logos_md">
        ...
        <div class="col-md-6" style="padding-top: 5px">
            <a href="#">
                <img class="img-responsive" src="<%out.print(getServletContext().getContextPath());%>/peam_resources/logos_principales/logo_peam_combinado_large.png" alt="" style="height: 80px"/>
            </a>
        </div>
