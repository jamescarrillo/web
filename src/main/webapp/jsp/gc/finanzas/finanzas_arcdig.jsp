                ...
                <form id="FrmDocumentosArcDig">
                    <div class="row">
                        <div class="form-group col-lg-5 col-md-6 col-12 mb-3">
                            <select id="comboEtiquetasDocumentosArcDig" name="comboEtiquetasDocumentosArcDig" class="form-control form-control-sm combo-paginar mr-3" idBtnBuscar='btnBuscarDocumentoArcDig'>
