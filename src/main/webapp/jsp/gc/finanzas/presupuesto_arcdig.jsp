    ...
    <div class="modal-dialog modal-lg modal-dialog-scroll" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-scroll">
                <input type="hidden" id="nameFormArcDig" value="FrmDocumentosArcDig">
                <input type="hidden" id="actionDocumentosArcDig" name="action" value="paginarDocumentosArcDig">
                <input type="hidden" id="numberPageDocumentosArcDig" name="numberPageDocumentosArcDig" value="1">
                <input type="hidden" id="txtTido" name="txtTido">
                <form id="FrmDocumentosArcDig">
                    <div class="row">
                        <input type="hidden" name="comboEtiquetasDocumentosArcDig" id="comboEtiquetasDocumentosArcDig" value="-1">
                        <div class="form-group col-lg-2 col-md-6 col-12 mb-3">
                            <select id="comboAnioDocumentosArcDig" name="comboAnioDocumentosArcDig" class="form-control form-control-sm combo-paginar mr-3" idBtnBuscar='btnBuscarDocumentoArcDig'>

                            </select>
                        </div>
                        <div class="input-group col-lg-10 col-12 mb-3">
                            ...
                            <button type="submit" id="btnBuscarDocumentoArcDig" class="btn waves-effect waves-light btn-info btn-sm mr-3" data-toggle="tooltip" title="Buscar Documento en ArcDig" style="height: 31px"><i class="fas fa-search" aria-hidden="true"></i> BUSCAR</button>
                        </div>
                    </div>
                </form>
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive" id="tablaDocumentosArcDig">
                            <table
                                ...
                                <thead>
                                    <tr>
                                        <th style="width: 25%" class="text-small-table">TÍTULO</th>
                                        <th class="text-small-table">RESUMEN</th>
                                        <th class="text-small-table">OP</th>
                                    </tr>
                                </thead>
