...
<html lang="es">
    ...
    <body class="fix-header fix-sidebar card-no-border">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-light">
                                    <strong class="text-info">GESTION DE DOCUMENTOS</strong>
                                </div>
                                    ...
                                    <form id="FrmDocumentos">
                                        <div class="row mt-3">
                                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                                <select id="cate_id" name="cate_id" class="form-control form-control-sm combo-paginar " idBtnBuscar='btnBuscarDocumento'>
        ...
        <script src="<%out.print(getServletContext().getContextPath());%>/js_app/gc/documentos_gestion.js"></script>
