...
<html lang="es">
    ...
    <body id="top" class="has-header-search">
                                        ...
                                        <form id="FrmSolicitud">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="col-6">
                                                        <div class="input-field">
                                                            ...
                                                            <label for="txtInteresado" class="">APELLIDOS Y NOMBRES/RAZON SOCIAL</label>
                                                        </div>
                                                    </div><!-- /.col-md-6 -->
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="col-6">
                                                        <div class="input-field">
                                                            ...
                                                            <label for="txtNroDocumento" class="">D.N.I/L.M./C.E./OTRO</label>
                                                        </div>
                                                    </div><!-- /.col-md-6 -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="col-6">
                                                        <div class="input-field">
                                                            <select id="comboTipoFormato" name="comboTipoFormato" class="form-control" style="border: 1px solid #00793D; margin-top: 40px">
                                                                <option value="-1">FORMATO DE ENTREGA</option>
                                                                <option value="1">COPIA SIMPLE</option>
                                                                <option value="2">COPIA FEDATEADA</option>
                                                                <option value="3">CD</option>
                                                                <option value="4">E_MAIL</option>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="col-6">
                                                        <div class="input-field">
                                                            <input type="text" name="txtDependencia" class="validate" id="txtDependencia">
                                                            <label for="txtDependencia" class="">DEPENDENCIA DE LA INFORMACIÓN</label>
                                                        </div>
                                                    </div><!-- /.col-md-6 -->
                                                </div><!-- /.row -->
                                            </div>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="col-12">
                                                        <div class="input-field">
                                                            ...
                                                            <label for="txtMensaje" class="">INFORMACIÓN SOLICITADA</label>
                                                        </div>
        ...
        <script type="text/javascript" src="<%out.print(getServletContext().getContextPath());%>/js_app/web/accesoinformacion.js"></script>
    </body>
</html>