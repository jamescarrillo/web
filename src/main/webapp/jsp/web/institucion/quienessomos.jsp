                        ...
                        <div class="border-tab transparent-nav">
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="tab-base_legal">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab-resenia_historica">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab-actualidad">
