                                        ...
                                        <div class="row">
                                            <form id="FrmGlosario">
                                                ...
                                                <div class="col-md-2 col-sm-3 col-xs-12">
                                                    <button type="submit" id="btnBuscarGlosario" class="waves-effect waves-light btn" style="height: 40px; padding-top: 5px; padding-bottom: 5px; margin-top: 35px;">Buscar</button>
                                                </div>
                                                ...
                                                <div class="table-responsive table-hover" style="margin-top: 20px">
                                                    <table class="table">
                                                        <thead class="bg-success">
                                                            <tr>
                                                                <th style="width: 25%;" class="text-center align-middle">TERMINO</th>
                                                                <th style="width: 75%;" class="text-center align-middle">SIGNIFICADO</th>
                                                            </tr>
                                                        </thead>
