        ...
        <section class="blog-section section-padding" style="padding-top: 50px">
            <div class="container">
                <div class="text-center mb-30" style="margin-top: 20px;">
                    <h2 class="text-peam-verde-subrayado" style="font-size: 30px">Presupuesto y Finanzas</h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="border-tab transparent-nav">
                            <ul class="nav nav-tabs nav-tabs-gt nav-justified" role="tablist">
                                <li role="presentation" class="active"><a href="#tab-presupuesto-insitucional" role="tab" class="waves-effect waves-dark" data-toggle="tab">Presupuesto Institucional</a></li>
                                <li role="presentation"><a href="#tab-informacion-financiera" role="tab" class="waves-effect waves-dark" data-toggle="tab">Información Financiera</a></li>
                                <li role="presentation"><a href="#tab-informacion-presupuestal" role="tab" class="waves-effect waves-dark" data-toggle="tab">Información Presupuestal</a></li>
                            </ul>
