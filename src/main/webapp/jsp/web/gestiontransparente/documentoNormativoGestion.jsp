                                        ...
                                        <div class="col-md-12">
                                            <div class="border-bottom-tab">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li role="presentation"><a style="padding-top: 5px; padding-bottom: 5px" href="#tab-actas-de-sesion" role="tab" class="waves-effect waves-dark item-documento" cate_id="2800" tido_id="" formulario="FrmDocumentos_AS" combo_anio="comboAnioDocumento_AS" data-toggle="tab">Actas de Sesión y Consejo Directivo</a></li>
                                                    ...
                                                    <li role="presentation"><a style="padding-top: 5px; padding-bottom: 5px" href="#tab-normas-y-directivas" role="tab" class="waves-effect waves-dark item-documento" cate_id="100" tido_id="12" formulario="FrmDocumentos_ND" combo_anio="comboAnioDocumento_ND" data-toggle="tab">Normas y Directivas</a></li>
                                                ...
                                                <div class="panel-body" style="padding-bottom: 0px;padding-top: 0px">
                                                    <div class="tab-content">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in" id="tab-actas-de-sesion">
                                                            <div class="row">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in" id="tab-documentos-de-gestion">
                                                            <div class="row">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in" id="tab-normas-y-directivas">
                                                            <div class="row">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in" id="tab-indicadores-de-desempenio">
                                                            <div class="row">
