...
function listarPenalidad(BEAN_PAGINATION) {
    ...
    if (BEAN_PAGINATION.COUNT_FILTER > 0) {
        ...
        $.each(BEAN_PAGINATION.LIST, function (index, value) {
            ...
            fila += ">";
            fila += "<td class='text-center align-middle text-medium-table'>" + value.monto_contrato + "</td>";
            ...
            fila += "<td class='align-middle text-medium-table'>" + value.tipo + "</td>";
            fila += "<td class='align-middle text-medium-table'>" + value.monto_penalidad + "</td>";
